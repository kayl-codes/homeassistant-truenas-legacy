...
SERVICE_DATASET_UNLOCK_PASSPHRASE = "passphrase"
SERVICE_DATASET_LOCK_FORCE_UNMOUNT = "force_unmount"
SERVICE_DATASET_UNLOCK_RECURSIVE = "recursive"
SERVICE_DATASET_UNLOCK_FORCE = "force"

SCHEMA_SERVICE_DATASET_LOCK = {vol.Required(SERVICE_DATASET_LOCK_FORCE_UNMOUNT, default=False): cv.boolean}
